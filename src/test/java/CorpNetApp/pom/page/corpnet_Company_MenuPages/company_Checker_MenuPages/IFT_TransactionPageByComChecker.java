...
public class IFT_TransactionPageByComChecker extends BaseTest {
    ...
    public IFT_TransactionPageByComChecker() {
        PageFactory.initElements(driver, this);
    }

    public IFT_TransactionPageByComChecker searchIFTBatchId(String iftID) throws InterruptedException {
...
//        fillIftBatchIdEl.sendKeys();
    ...
    public IFT_TransactionPageByComChecker clickAuthorizeBtn() throws InterruptedException {
    ...
    public IFT_TransactionPageByComChecker clickSubmitBtn() throws InterruptedException {
        Thread.sleep(10000);
    ...
    public IFT_TransactionPageByComChecker clickRejectBtn() {
        clickRejectBtnEl.isDisplayed();
        clickRejectBtnEl.click();
        return this;

    }
    public IFT_TransactionPageByComChecker fillRejectReason(String rejectReason) {
