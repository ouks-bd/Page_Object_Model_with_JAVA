...
public class EFT__Single_TransactionPageByComApprove extends BaseTest {
    ...
    public EFT__Single_TransactionPageByComApprove(){
        PageFactory.initElements(driver,this);
    }
    public EFT__Single_TransactionPageByComApprove searchIFTBatchId(String eftRef) throws InterruptedException {
       Thread.sleep(10000);
        fillIftBatchIdEl.isDisplayed();
        Thread.sleep(5000);
        // iftChBatch = fillIftBatchIdEl.getText();
        fillIftBatchIdEl.sendKeys(eftRef);
        Thread.sleep(5000);
        return this;
    }

    public EFT__Single_TransactionPageByComApprove clickApproveBtn() throws InterruptedException {
        clickApproveBtnEl.isDisplayed();
        clickApproveBtnEl.click();
        Thread.sleep(2000);
        return this;
    }
    public EFT__Single_TransactionPageByComApprove clickOkkBtn() throws InterruptedException {
        clickOkBtnEl.isDisplayed();
        clickOkBtnEl.click();
        Thread.sleep(2000);
        return this;
    }
    public EFT__Single_TransactionPageByComApprove inputTokenNumber(){
    ...
    public EFT__Single_TransactionPageByComApprove clickApproveTokenBtn() throws InterruptedException {
    ...
    public EFT__Single_TransactionPageByComApprove clickYesBtn() throws InterruptedException {
