...
public class IFT_TransactionPageByComApprove extends BaseTest {
    ...
    public IFT_TransactionPageByComApprove(){
        PageFactory.initElements(driver,this);
    }
    public IFT_TransactionPageByComApprove searchIFTBatchId(String iftAppID) throws InterruptedException {
       ...
       // iftChBatch = fillIftBatchIdEl.getText();
        fillIftBatchIdEl.sendKeys(iftAppID);
        Thread.sleep(3000);
        return this;
    }

    public IFT_TransactionPageByComApprove clickApproveBtn() throws InterruptedException {
        clickApproveBtnEl.isDisplayed();
        clickApproveBtnEl.click();
        Thread.sleep(50000);
        return this;
    }
    public IFT_TransactionPageByComApprove inputTokenNumber(){
    ...
    public IFT_TransactionPageByComApprove clickApproveTokenBtn() throws InterruptedException {
    ...
    public IFT_TransactionPageByComApprove clickYesBtn() throws InterruptedException {
