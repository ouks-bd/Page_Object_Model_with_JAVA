...
public class EFT_TransactionPageByComApprove extends BaseTest {
    ...
    public EFT_TransactionPageByComApprove() throws InterruptedException {

        PageFactory.initElements(driver,this
        );
        Thread.sleep(5000);
    }
    public EFT_TransactionPageByComApprove searchIFTBatchId(String iftSingleRefID) throws InterruptedException {
        Thread.sleep(10000);
    ...
    public EFT_TransactionPageByComApprove clickApproveBtn() throws InterruptedException {
        clickApproveBtnEl.isDisplayed();
        clickApproveBtnEl.click();
        Thread.sleep(2000);
        return this;
    }
    public EFT_TransactionPageByComApprove clickOkkBtn() throws InterruptedException {
        clickOkBtnEl.isDisplayed();
        clickOkBtnEl.click();
        Thread.sleep(2000);
        return this;
    }
    public EFT_TransactionPageByComApprove inputTokenNumber(){
    ...
    public EFT_TransactionPageByComApprove clickApproveTokenBtn() throws InterruptedException {
    ...
    public EFT_TransactionPageByComApprove clickYesBtn() throws InterruptedException {
