...
public class TC_03_Others_BeneficiaryAddByComMaker extends BaseTest {

    Add_Beneficiary_Page _add_beneficiary_page;

    public TC_03_Others_BeneficiaryAddByComMaker(){
        super();
    }
    @BeforeMethod
    public void setUp(){
        initialization();
        _add_beneficiary_page =new CompanyUsersLoginPage().CompMCUserLogin(getTranMCUser(),getTranMakerPass()).clickOthersBeneficiaryMenu();
    }
    @Test
    public void addPayrollBeneficiarySuccess() throws InterruptedException {
        _add_beneficiary_page = _add_beneficiary_page
                .fillOthersBeneficiaryInfo()
                .clickBtn();
