...
public class TC_Payroll_Bulk_Approve_TransferByComApprover extends BaseTest {

    Payroll_Single_TransactionPageByComApprove payroll_single_transactionPageByComApprove;
    MockData mockData;

    public TC_Payroll_Bulk_Approve_TransferByComApprover() {
        super();
    }
    ...
    public void setUp() throws InterruptedException {
        initialization();
        payroll_single_transactionPageByComApprove = new CompanyUsersLoginPage().CompApproveUserLogin(getTranCompApproveUser(), getTranMakerPass()).clickPayrollBulkApproveQueue();
