...
public class TC_Payroll_Bulk_TransferByComChecker extends BaseTest {
    Payroll_TransactionPageByComChecker payroll_transactionPageByComChecker;

    public TC_Payroll_Bulk_TransferByComChecker() {
        super();
    }
    ...
    public void SetUP() {
        ...
        payroll_transactionPageByComChecker = new CompanyUsersLoginPage().CompMakerLogin(getTranCompCheckerUser(), getTranMakerPass()).ClickVerifyPayroll();

    }

    @Test
    public void authorized_Bulk_Payroll_TranSuccess(ITestContext context) throws InterruptedException, EntityNotFoundException {
