...
public class TC_EFT_Bulk_Many_Many_TransferByComChecker extends BaseTest {
    EFT_TransactionPageByComChecker eft_transactionPageByComChecker;


    public TC_EFT_Bulk_Many_Many_TransferByComChecker() {
        super();
    }
    ...
    @Test(priority = 0)
    public void authorized_EFT_Many_Many_TranSuccess(ITestContext context) throws InterruptedException, EntityNotFoundException {
