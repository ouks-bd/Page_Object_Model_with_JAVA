...
public class TC_DD_Own_Approve_TransferByComApprover extends BaseTest {

    DD_TransactionPageByComApprove dd_transactionPageByComApprove;
    MockData mockData;

    public TC_DD_Own_Approve_TransferByComApprover() {
        super();
    }
    ...
    @Test(priority = 2)
    public void Approve_Own_EFT_IFT_TranSuccess(ITestContext context) throws InterruptedException {
        ...
        String DDBatchRefID = (String) context.getAttribute("DDTranBatchRefNo");
            ...
            mockData.updateToExcel(37,DDBatchRefID);
