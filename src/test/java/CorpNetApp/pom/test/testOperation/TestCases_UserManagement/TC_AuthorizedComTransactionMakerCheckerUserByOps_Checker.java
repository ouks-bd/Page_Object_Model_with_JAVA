...
public class TC_AuthorizedComTransactionMakerCheckerUserByOps_Checker extends BaseTest {
    ApproveComUnAuthorizeUserPageByChecker approveComUnAuthorizeUserPageByChecker;

    public TC_AuthorizedComTransactionMakerCheckerUserByOps_Checker() {
        super();
    }
    ...
    @Test
    public void ApproveMakerUserSuccess() throws InterruptedException {
        approveComUnAuthorizeUserPageByChecker = approveComUnAuthorizeUserPageByChecker
                .selectCompany()
